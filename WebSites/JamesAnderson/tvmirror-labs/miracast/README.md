...
- App path: `miracast`
- Website URL: `https://tvmirror-labs.web.app/miracast`
- Contact URL: `https://tvmirror-labs.web.app/miracast/contact`
- Term URL: `https://tvmirror-labs.web.app/miracast/term`
- Privacy URL: `https://tvmirror-labs.web.app/miracast/privacy`
...
```bash
cd /Users/thi/Desktop/SupportHTML/Firebase_Host/WebSites/JamesAnderson/tvmirror-labs/miracast/Deploy
./deploy.sh --dry-run
./deploy.sh
```
